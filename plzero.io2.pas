...
begin writeln(' start pl/0');
   ...
   repeat i := code[p]; p := p + 1;
      ...
      sto: begin s[base(l)+a] := s[t]; zz:= zz+1; if (zz mod 3) = 0 then begin write('! '); writeln(s[t]) end; t := t - 1
           end;
      outp: begin s[base(l)+a] := s[t]; write('! '); writeln(s[t]); t := t - 1
           end;
